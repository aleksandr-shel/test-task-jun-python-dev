...
С помощью команды setup_roles создаются роли в базе данных и пользователь admin с ролью admin.

Пользователь с ролью admin или manager может назначить новые роли пользователям.